...
namespace Aizen.Bff.AdminPanel.Application.AdminPayment.Command.CreateProviderPlan;

public sealed class CreateProviderPlanBffCommand : AizenCommand<PlanMutateBffResult>
{
