...
public sealed class RegisterOrganizerVerificationDocumentBffCommand : AizenCommand<RegisterDocumentBffResponse>
{
    ...
    public RegisterOrganizerVerificationDocumentBffCommand(
