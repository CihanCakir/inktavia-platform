...
public sealed class RegisterOrganizerVerificationDocumentBffCommandHandler
    : AizenCommandHandler<RegisterOrganizerVerificationDocumentBffCommand, RegisterDocumentBffResponse>
{
    private readonly IFileStorageRemoteCall _fileStorage;
    private readonly IIdentityRemoteCall _identity;
    private readonly ILogger<RegisterOrganizerVerificationDocumentBffCommandHandler> _logger;

    public RegisterOrganizerVerificationDocumentBffCommandHandler(
        IFileStorageRemoteCall fileStorage,
        IIdentityRemoteCall identity,
        ILogger<RegisterOrganizerVerificationDocumentBffCommandHandler> logger)
    {
    ...
    public override async Task<RegisterDocumentBffResponse?> Handle(
        RegisterOrganizerVerificationDocumentBffCommand request, CancellationToken cancellationToken)
    {
