...
public sealed class RegisterVenueVerificationDocumentBffCommand : AizenCommand<RegisterDocumentBffResponse>
{
    ...
    public RegisterVenueVerificationDocumentBffCommand(
