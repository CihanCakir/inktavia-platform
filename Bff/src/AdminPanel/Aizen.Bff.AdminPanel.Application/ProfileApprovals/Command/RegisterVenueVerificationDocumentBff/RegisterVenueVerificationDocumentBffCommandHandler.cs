...
public sealed class RegisterVenueVerificationDocumentBffCommandHandler
    : AizenCommandHandler<RegisterVenueVerificationDocumentBffCommand, RegisterDocumentBffResponse>
{
    private readonly IFileStorageRemoteCall _fileStorage;
    private readonly IIdentityRemoteCall _identity;
    private readonly ILogger<RegisterVenueVerificationDocumentBffCommandHandler> _logger;

    public RegisterVenueVerificationDocumentBffCommandHandler(
        IFileStorageRemoteCall fileStorage,
        IIdentityRemoteCall identity,
        ILogger<RegisterVenueVerificationDocumentBffCommandHandler> logger)
    {
    ...
    public override async Task<RegisterDocumentBffResponse?> Handle(
        RegisterVenueVerificationDocumentBffCommand request, CancellationToken cancellationToken)
    {
