...
public sealed class RequestVenueDocumentUploadUrlBffCommandHandler
    : AizenCommandHandler<RequestVenueDocumentUploadUrlBffCommand, DocumentUploadUrlBffResponse>
{
    private readonly IFileStorageRemoteCall _fileStorage;
    private readonly ILogger<RequestVenueDocumentUploadUrlBffCommandHandler> _logger;

    public RequestVenueDocumentUploadUrlBffCommandHandler(
        IFileStorageRemoteCall fileStorage,
        ILogger<RequestVenueDocumentUploadUrlBffCommandHandler> logger)
    {
    ...
    public override async Task<DocumentUploadUrlBffResponse?> Handle(
        RequestVenueDocumentUploadUrlBffCommand request, CancellationToken cancellationToken)
    {
