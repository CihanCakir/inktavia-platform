...
public sealed class ChangeDisputeStatusBffCommandHandler
    : AizenCommandHandler<ChangeDisputeStatusBffCommand, AdminBffCommandResultDto>
{
    private readonly IServiceRequestRemoteCall _serviceRequest;

    public ChangeDisputeStatusBffCommandHandler(IServiceRequestRemoteCall serviceRequest)
    {
        _serviceRequest = serviceRequest;
    }

    public override async Task<AdminBffCommandResultDto?> Handle(
        ChangeDisputeStatusBffCommand request, CancellationToken cancellationToken)
    {
