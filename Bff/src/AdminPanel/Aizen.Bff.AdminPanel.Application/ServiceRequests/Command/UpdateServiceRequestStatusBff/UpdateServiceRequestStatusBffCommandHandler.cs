...
public sealed class UpdateServiceRequestStatusBffCommandHandler
    : AizenCommandHandler<UpdateServiceRequestStatusBffCommand, UpdateServiceRequestStatusResponse>
{
    private readonly IServiceRequestRemoteCall _serviceRequest;

    public UpdateServiceRequestStatusBffCommandHandler(IServiceRequestRemoteCall serviceRequest)
    {
        _serviceRequest = serviceRequest;
    }

    public override async Task<UpdateServiceRequestStatusResponse?> Handle(
        UpdateServiceRequestStatusBffCommand request, CancellationToken cancellationToken)
    {
