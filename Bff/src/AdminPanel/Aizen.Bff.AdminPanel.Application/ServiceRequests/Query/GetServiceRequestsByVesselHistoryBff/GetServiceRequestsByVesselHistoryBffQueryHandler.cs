...
public sealed class GetServiceRequestsByVesselHistoryBffQueryHandler
    : AizenQueryHandler<GetServiceRequestsByVesselHistoryBffQuery, ServiceRequestVesselHistoryBffResponse>
{
    private readonly IServiceRequestRemoteCall _serviceRequest;

    public GetServiceRequestsByVesselHistoryBffQueryHandler(
    ...
    public override async Task<ServiceRequestVesselHistoryBffResponse?> Handle(
        GetServiceRequestsByVesselHistoryBffQuery request, CancellationToken cancellationToken)
    {
