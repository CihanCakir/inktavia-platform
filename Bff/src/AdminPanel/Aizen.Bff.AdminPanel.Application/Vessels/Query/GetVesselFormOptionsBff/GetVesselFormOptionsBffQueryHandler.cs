...
public sealed class GetVesselFormOptionsBffQueryHandler
    : AizenQueryHandler<GetVesselFormOptionsBffQuery, AdminVesselFormOptionsResponse>
{
    public override Task<AdminVesselFormOptionsResponse?> Handle(
        GetVesselFormOptionsBffQuery request, CancellationToken cancellationToken)
    {
