...
public sealed class GetVesselListBffQueryHandler
    : AizenQueryHandler<GetVesselListBffQuery, AdminVesselListBffResponse>
{
    private readonly IVesselRemoteCall _vessel;
    private readonly IIdentityRemoteCall _identity;
    private readonly ILogger<GetVesselListBffQueryHandler> _logger;
    ...
    public GetVesselListBffQueryHandler(
        IVesselRemoteCall vessel,
        IIdentityRemoteCall identity,
        ILogger<GetVesselListBffQueryHandler> logger)
    {
        _vessel = vessel;
        _identity = identity;
        _logger = logger;
    ...
    public override async Task<AdminVesselListBffResponse?> Handle(
        GetVesselListBffQuery request, CancellationToken cancellationToken)
    {
