...
public sealed class GetVesselRegisterBootstrapBffQueryHandler
    : AizenQueryHandler<GetVesselRegisterBootstrapBffQuery, AdminVesselRegisterBootstrapBffResponse>
{
    ...
    public GetVesselRegisterBootstrapBffQueryHandler(
    ...
    public override async Task<AdminVesselRegisterBootstrapBffResponse?> Handle(
        GetVesselRegisterBootstrapBffQuery request, CancellationToken cancellationToken)
    {
