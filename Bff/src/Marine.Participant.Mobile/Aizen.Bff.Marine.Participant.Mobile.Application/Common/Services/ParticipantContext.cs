...
internal sealed class ParticipantContext : IParticipantContext
{
    private readonly ClaimsPrincipal? _user;
    private readonly MarineMobileKeycloakOptions _options;

    public ParticipantContext(IHttpContextAccessor httpContextAccessor, IOptions<MarineMobileKeycloakOptions> options)
    {
