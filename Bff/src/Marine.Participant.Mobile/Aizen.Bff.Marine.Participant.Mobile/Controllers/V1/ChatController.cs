...
public sealed class MobileChatController : AizenWebApiController
{
    private readonly IAizenCQRSProcessor _cqrs;

    public MobileChatController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
