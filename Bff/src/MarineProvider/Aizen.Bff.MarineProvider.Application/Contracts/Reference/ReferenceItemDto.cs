namespace Aizen.Bff.MarineProvider.Application.Contracts.Reference;

/// <summary>A single lookup option surfaced to the provider web client (dropdowns). Trimmed from the module
/// LookupItemDto — mirrors the mobile BFF's ReferenceItemDto (incl. the localized DisplayNameTr).</summary>
