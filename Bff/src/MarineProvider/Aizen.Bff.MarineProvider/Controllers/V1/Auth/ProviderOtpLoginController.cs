using Aizen.Bff.MarineProvider.Application.Auth.OtpLogin.RequestOtpLogin;
using Aizen.Bff.MarineProvider.Application.Auth.OtpLogin.VerifyOtpLogin;
using Aizen.Bff.MarineProvider.Application.Auth.OtpLogin.ResendOtpLogin;
...
public sealed class ProviderOtpLoginController : AizenWebApiController
{
    ...
    public ProviderOtpLoginController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
