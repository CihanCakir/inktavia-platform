...
using Aizen.Bff.MarineProvider.Application.Files.CreateUploadSession;
using Aizen.Bff.MarineProvider.Application.Files.CompleteUpload;
...
[Tags("Provider - Files")]
[Authorize]
public sealed class ProviderFileController : AizenWebApiController
{
    private readonly IAizenCQRSProcessor _cqrs;

    public ProviderFileController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
