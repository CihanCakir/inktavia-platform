...
using Aizen.Bff.MarineProvider.Application.Onboarding;
using Aizen.Bff.MarineProvider.Application.Onboarding;
using Aizen.Bff.MarineProvider.Application.Onboarding;
using Aizen.Bff.MarineProvider.Application.Onboarding;
...
[Authorize]
public sealed class OnboardingController : AizenWebApiController
{
    private readonly IAizenCQRSProcessor _cqrs;

    public OnboardingController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
