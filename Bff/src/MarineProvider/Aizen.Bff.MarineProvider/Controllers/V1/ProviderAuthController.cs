using Aizen.Bff.MarineProvider.Application.Auth.EnsureProviderProfile;
using Aizen.Bff.MarineProvider.Application.Auth.RegisterProvider;
...
[Tags("Provider - Auth")]
public sealed class ProviderAuthController : AizenWebApiController
{
    private readonly IAizenCQRSProcessor _cqrs;

    public ProviderAuthController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
