...
using Aizen.Bff.MarineProvider.Application.Me.GetProviderMe;
using Aizen.Bff.MarineProvider.Application.Me.GetProviderProfile;
using Aizen.Bff.MarineProvider.Application.Me.GetProviderStatus;
using Aizen.Bff.MarineProvider.Application.Phone.SendProviderPhoneOtp;
using Aizen.Bff.MarineProvider.Application.Phone.VerifyProviderPhoneOtp;
...
public sealed class ProviderMeController : AizenWebApiController
{
    private readonly IAizenCQRSProcessor _cqrs;

    public ProviderMeController(IHttpContextAccessor httpContextAccessor, IAizenCQRSProcessor cqrs)
