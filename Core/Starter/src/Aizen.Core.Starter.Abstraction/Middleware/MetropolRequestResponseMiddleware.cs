...
public class AizenRequestResponseMiddleware
{
    private readonly RequestDelegate next;
    private readonly RecyclableMemoryStreamManager _recyclableMemoryStreamManager;

    public AizenRequestResponseMiddleware(RequestDelegate Next)
    {
        next = Next;
    ...
    public async Task Invoke(HttpContext httpContext)
    {
        ...
        // var requestText = await getRequestBody(httpContext);
        // Elastic.Apm.Agent.Tracer.CurrentTransaction.SetLabel("HttpRequestBody", requestText);
        ...
        Elastic.Apm.Agent.Tracer.CurrentTransaction.SetLabel("HttpResponseBody", responseText);
    ...
    private static bool UnavailableStateToRequestResponse(HttpContext httpContext)
    {
        return httpContext.Request.Path == "/info" ||
               ...
               Elastic.Apm.Agent.Tracer?.CurrentTransaction is null;
    }
