    ...
    : AizenBaseMessageConsumer<CommerceOrderCompletedMessage>
{
    ...
    public override Task<bool> ExecutePrepareMessage(CommerceOrderCompletedMessage message, CancellationToken ct)
        => Task.FromResult(true);

    public override async Task ExecuteCommitMessage(CommerceOrderCompletedMessage message, CancellationToken ct)
    {
