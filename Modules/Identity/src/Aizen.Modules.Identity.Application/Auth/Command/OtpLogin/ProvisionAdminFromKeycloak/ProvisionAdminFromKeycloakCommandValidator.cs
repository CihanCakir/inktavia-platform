...
public sealed class ProvisionAdminFromKeycloakCommandValidator
    : AizenValidator<ProvisionAdminFromKeycloakCommand>
{
    public ProvisionAdminFromKeycloakCommandValidator()
    {
