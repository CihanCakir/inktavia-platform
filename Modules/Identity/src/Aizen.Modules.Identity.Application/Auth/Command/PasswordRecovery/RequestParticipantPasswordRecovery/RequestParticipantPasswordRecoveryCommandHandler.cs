...
public sealed class RequestParticipantPasswordRecoveryCommandHandler
    : AizenCommandHandler<RequestParticipantPasswordRecoveryCommand, RequestProviderPasswordRecoveryResponse>
{
    private readonly IParticipantPasswordRecoveryDomainService _service;

    public RequestParticipantPasswordRecoveryCommandHandler(IParticipantPasswordRecoveryDomainService service)
    {
        _service = service;
    }

    public override async Task<RequestProviderPasswordRecoveryResponse?> Handle(
        RequestParticipantPasswordRecoveryCommand request, CancellationToken cancellationToken)
    {
