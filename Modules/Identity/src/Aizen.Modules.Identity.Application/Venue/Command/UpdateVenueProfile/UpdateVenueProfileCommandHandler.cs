...
namespace Aizen.Modules.InktaviaStore.Application.Identity.Command.Venue.UpdateVenueProfile
{
    public class UpdateVenueProfileCommandHandler : AizenCommandHandler<UpdateVenueProfileCommand, ProfileUpdateResult>
    {
        ...
        public UpdateVenueProfileCommandHandler(
        ...
        public override async Task<ProfileUpdateResult?> Handle(UpdateVenueProfileCommand req, CancellationToken ct)
        {
            ...
            var ctx = WorkshopRoleContext.VenueOwner;
            ...
            return new ProfileUpdateResult(true, ctx, user.Id, active.Id, "Venue profile updated.");
        }
    }
