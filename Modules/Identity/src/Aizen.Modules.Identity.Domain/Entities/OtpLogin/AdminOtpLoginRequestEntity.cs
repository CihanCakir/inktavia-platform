...
public class AdminOtpLoginRequestEntity : AizenEntityWithAudit
{
    ...
    protected AdminOtpLoginRequestEntity() { }

    public static AdminOtpLoginRequestEntity Create(
        string loginRequestId, string keycloakSubjectId, long userId, long? adminProfileId,
        ...
        string otpHash, string otpSalt, DateTime otpExpiresAtUtc, int maxAttempts)
    {
        ...
        return new AdminOtpLoginRequestEntity
        {
            LoginRequestId = loginRequestId, KeycloakSubjectId = keycloakSubjectId,
            UserId = userId, AdminProfileId = adminProfileId,
