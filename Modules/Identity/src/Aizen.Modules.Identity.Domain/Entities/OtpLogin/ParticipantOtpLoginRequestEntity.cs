...
public class ParticipantOtpLoginRequestEntity : AizenEntityWithAudit
{
    ...
    protected ParticipantOtpLoginRequestEntity() { }

    public static ParticipantOtpLoginRequestEntity Create(
        string loginRequestId, string keycloakSubjectId, long userId, long? participantProfileId,
        ...
        string otpHash, string otpSalt, DateTime otpExpiresAtUtc, int maxAttempts)
    {
        ...
        return new ParticipantOtpLoginRequestEntity
        {
            LoginRequestId = loginRequestId, KeycloakSubjectId = keycloakSubjectId,
            UserId = userId, ParticipantProfileId = participantProfileId,
