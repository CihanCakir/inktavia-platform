...
public class ParticipantPasswordRecoveryRequestEntityConfiguration
    : IEntityTypeConfiguration<ParticipantPasswordRecoveryRequestEntity>
{
    public void Configure(EntityTypeBuilder<ParticipantPasswordRecoveryRequestEntity> builder)
    {
        builder.ToTable("participant_password_recovery_requests");
