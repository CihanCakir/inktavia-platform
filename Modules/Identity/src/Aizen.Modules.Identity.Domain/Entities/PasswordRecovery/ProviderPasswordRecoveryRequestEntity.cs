...
public class ProviderPasswordRecoveryRequestEntity : AizenEntityWithAudit
{
    ...
    protected ProviderPasswordRecoveryRequestEntity() { }

    public static ProviderPasswordRecoveryRequestEntity Create(
        ...
        int maxAttempts)
    {
        ...
        return new ProviderPasswordRecoveryRequestEntity
        {
