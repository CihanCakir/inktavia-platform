// src/Aizen.Modules.Identity.Repository/DesignTime/IdentityIdentityDesignTimeFactory.cs
using System;
using System.IO;
...
namespace Aizen.Modules.Identity.Repository.DesignTime
{
    public class IdentityDesignTimeFactory : IDesignTimeDbContextFactory<IdentityDbContext>
    {
        private const string STARTUP_PROJECT_NAME = "Aizen.Modules.Identity";
        ...
        public IdentityDbContext CreateDbContext(string[] args)
        {
            ...
            var opts = new DbContextOptionsBuilder<IdentityDbContext>()
                .UseNpgsql(cs, b => b.MigrationsAssembly("Aizen.Modules.Identity.Repository"))
