...
{
    /// <inheritdoc />
    public partial class AddProviderPasswordRecoveryRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_provider_password_recovery_requests", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_provider_password_recovery_requests_ResetRequestId",
                table: "provider_password_recovery_requests",
