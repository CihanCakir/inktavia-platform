...
{
    /// <inheritdoc />
    public partial class AddProviderOtpLoginRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_provider_otp_login_requests", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_provider_otp_login_requests_LoginRequestId",
                table: "provider_otp_login_requests",
