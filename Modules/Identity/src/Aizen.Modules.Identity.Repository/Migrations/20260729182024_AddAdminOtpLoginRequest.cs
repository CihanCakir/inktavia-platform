...
{
    /// <inheritdoc />
    public partial class AddAdminOtpLoginRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminProfileId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_admin_otp_login_requests", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_admin_otp_login_requests_LoginRequestId",
