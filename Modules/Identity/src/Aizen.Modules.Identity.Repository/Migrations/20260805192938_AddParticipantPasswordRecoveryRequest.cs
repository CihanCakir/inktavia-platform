...
{
    /// <inheritdoc />
    public partial class AddParticipantPasswordRecoveryRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetRequestId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ...
                    ResetTokenSalt = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_participant_password_recovery_requests", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_participant_password_recovery_requests_ResetRequestId",
                table: "participant_password_recovery_requests",
