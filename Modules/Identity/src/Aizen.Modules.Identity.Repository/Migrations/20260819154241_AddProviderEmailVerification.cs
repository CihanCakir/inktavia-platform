...
{
    /// <inheritdoc />
    public partial class AddProviderEmailVerification : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_provider_email_verifications", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_provider_email_verifications_UserId",
                table: "provider_email_verifications",
                column: "UserId");
        }
