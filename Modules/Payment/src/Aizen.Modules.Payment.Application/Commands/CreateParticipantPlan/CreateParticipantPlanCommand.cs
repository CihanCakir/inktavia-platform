...
public sealed class CreateParticipantPlanCommand : AizenCommand<CreateParticipantPlanResult>
{
...
public sealed record CreateParticipantPlanResult(long Id, string PlanCode);
