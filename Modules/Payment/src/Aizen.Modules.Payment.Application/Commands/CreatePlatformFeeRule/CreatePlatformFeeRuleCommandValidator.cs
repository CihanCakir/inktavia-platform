...
public sealed class CreatePlatformFeeRuleCommandValidator
    : AbstractValidator<CreatePlatformFeeRuleCommand>
{
    public CreatePlatformFeeRuleCommandValidator()
    {
        ...
        // Rate (when supplied) is a fraction in (0,1).
        ...
        // ── Model coherence (mirrors the domain factory guard) ──────────────────
        RuleFor(x => x.Rate)
