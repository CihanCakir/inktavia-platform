...
public sealed class UpdateProfitProtectionPolicyCommand : AizenCommand<UpdateProfitProtectionPolicyResult>
{
...
public sealed record UpdateProfitProtectionPolicyResult(long Id, string? PolicyCode);
