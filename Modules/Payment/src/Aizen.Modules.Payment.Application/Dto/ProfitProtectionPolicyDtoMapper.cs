...
public static class ProfitProtectionPolicyDtoMapper
{
    public static ProfitProtectionPolicyDto ToDto(ProfitProtectionPolicyEntity p) => new(
        ...
        p.DefaultLineMinProviderReceivableRate,
        p.DefaultLineMinProviderReceivableAmount,
        p.DefaultAllowedProviderFundedDiscountRate,
        p.DefaultAllowedPlatformFundedDiscountRate,
        p.LineCommissionFloorRate,
        p.MinLinePlatformContributionRate,
        p.StrategicLossExceptionEnabled,
        p.StrategicLossExceptionMaxLineDeficit,
        p.AdjustmentOrder,
        p.EffectiveFrom,
        p.EffectiveTo,
        p.Status,
