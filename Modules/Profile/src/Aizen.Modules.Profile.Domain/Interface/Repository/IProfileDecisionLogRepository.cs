...
/// </summary>
public interface IProfileDecisionLogRepository
{
    Task<List<ProfileDecisionLogEntity>> GetByProfileAsync(
    ...
    Task AddAsync(ProfileDecisionLogEntity entity, CancellationToken ct);
