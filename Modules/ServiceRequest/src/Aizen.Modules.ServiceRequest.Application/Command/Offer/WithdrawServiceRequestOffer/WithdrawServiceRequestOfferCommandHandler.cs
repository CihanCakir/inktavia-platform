...
[DocumentationInfo("Withdraw offer command handler", "Provider withdraws the offer and publishes realtime event.")]
public sealed class WithdrawServiceRequestOfferCommandHandler : AizenCommandHandler<WithdrawServiceRequestOfferCommand, WithdrawServiceRequestOfferResponse>
{
    ...
    public WithdrawServiceRequestOfferCommandHandler(
    ...
    public override async Task<WithdrawServiceRequestOfferResponse?> Handle(WithdrawServiceRequestOfferCommand request, CancellationToken cancellationToken)
    {
        ...
        return new WithdrawServiceRequestOfferResponse(offer.Id);
    }
}
