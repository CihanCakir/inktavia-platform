...
namespace Aizen.Modules.ServiceRequest.Repository.DesignTime;

public class ServiceRequestDesignTimeFactory : IDesignTimeDbContextFactory<ServiceRequestDbContext>
{
    private const string STARTUP_PROJECT_NAME = "Aizen.Modules.ServiceRequest";
    private const string DB_NAME = "ServiceRequest";
    ...
    public ServiceRequestDbContext CreateDbContext(string[] args)
    {
        ...
        var opts = new DbContextOptionsBuilder<ServiceRequestDbContext>()
            .UseNpgsql(cs, b => b.MigrationsAssembly("Aizen.Modules.ServiceRequest.Repository"))
            .Options;

        return new ServiceRequestDbContext(opts);
    }
