...
public sealed class UpdateVesselDocumentStatusCommandHandler : AizenCommandHandler<UpdateVesselDocumentStatusCommand, bool>
{
    private readonly IVesselDocumentRepository _documentRepository;
    private readonly IVesselCacheInvalidationService _invalidation;

    public UpdateVesselDocumentStatusCommandHandler(IVesselDocumentRepository documentRepository, IVesselCacheInvalidationService invalidation)
    {
        _documentRepository = documentRepository;
        _invalidation = invalidation;
    }

    public override async Task<bool> Handle(UpdateVesselDocumentStatusCommand request, CancellationToken cancellationToken)
    {
