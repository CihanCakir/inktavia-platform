...
public sealed class UpdateVesselLocationSnapshotCommandHandler : AizenCommandHandler<UpdateVesselLocationSnapshotCommand, UpdateVesselLocationSnapshotResponse>
{
    ...
    public override async Task<UpdateVesselLocationSnapshotResponse?> Handle(UpdateVesselLocationSnapshotCommand request, CancellationToken cancellationToken)
    {
        ...
        return new UpdateVesselLocationSnapshotResponse(snapshot.ToDto());
    }
}
