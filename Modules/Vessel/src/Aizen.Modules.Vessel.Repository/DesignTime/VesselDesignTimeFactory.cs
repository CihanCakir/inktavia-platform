...
namespace Aizen.Modules.Vessel.Repository.DesignTime;

public class VesselDesignTimeFactory : IDesignTimeDbContextFactory<VesselDbContext>
{
    private const string STARTUP_PROJECT_NAME = "Aizen.Modules.Vessel";
    private const string DB_NAME = "Vessel";
    ...
    public VesselDbContext CreateDbContext(string[] args)
    {
        ...
        var opts = new DbContextOptionsBuilder<VesselDbContext>()
            .UseNpgsql(cs, b => b.MigrationsAssembly("Aizen.Modules.Vessel.Repository"))
            .Options;

        return new VesselDbContext(opts);
    }
