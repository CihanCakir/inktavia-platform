...
- **Sıradaki: S9** (line profit protection — S5 min-receivable floor + funded cap'leri kabul ekonomisine uygular; P5+S8 hazır). Not: S2–S5 backend+FE **henüz commit'siz**.
